...
class Resizing_Generator(nn.Module):
    # for 256,256 
    def __init__(self,n_res=3,use_bias=False):
        super().__init__()
        
        self.n_res=n_res
        self.use_bias=use_bias
        self.down_sampling=nn.Sequential(
            nn.Conv2d(3,32,kernel_size=7,stride=1,padding=0,bias=use_bias),
            nn.BatchNorm2d(32,affine=True),
            nn.LeakyReLU(0.2,inplace=True),
            nn.Conv2d(32,64,kernel_size=3,stride=2,padding=3,bias=use_bias),
        ...
        for i in range(n_res):
            res_block.append(ResBlk(128,128,normalize=True,use_bias=self.use_bias))
        ...
        self.up_sampling = nn.Sequential(
            ...
            nn.ConvTranspose2d(64,64, kernel_size=3, stride=2, padding=0, output_padding=1, bias=use_bias),
            nn.BatchNorm2d(64,affine=True),
            nn.LeakyReLU(0.2,inplace=True),
